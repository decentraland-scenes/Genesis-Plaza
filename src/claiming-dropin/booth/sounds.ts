const SOUND_BASE_DIR = "src/claiming-dropin/"

// Open dialog sound
export const openDialogSound = new Entity()
openDialogSound.addComponent(new Transform())
openDialogSound.addComponent(
  new AudioSource(new AudioClip(SOUND_BASE_DIR+'sounds/navigationForward.mp3'))
)
...
closeDialogSound.addComponent(
  new AudioSource(new AudioClip(SOUND_BASE_DIR+'sounds/navigationBackward.mp3'))
)
...
coinSound.addComponent(
  new AudioSource(new AudioClip(SOUND_BASE_DIR+'sounds/star-collect.mp3'))
)
